...
public final class TodoItemView_
    extends TodoItemView
    implements HasViews, OnViewChangedListener
{
    ...
    public TodoItemView_(Context context) {
        super(context);
        init_();
    }

    public static TodoItemView build(Context context) {
        TodoItemView_ instance = new TodoItemView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.list_item_todo, this);
